 ...
 * @author qn052
 */
public class EditCostFrm extends javax.swing.JDialog {

    /** Creates new form EditServiceFrm */
    private final FrameChiPhi DichVu;
    public EditCostFrm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        DichVu = (FrameChiPhi) parent;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditCostFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditCostFrm dialog = new EditCostFrm(new javax.swing.JFrame(), true);
