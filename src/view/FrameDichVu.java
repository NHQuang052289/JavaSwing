 ...
 * @author qn052
 */
public class FrameDichVu extends javax.swing.JFrame {

    /**
     * Creates new form FrameDichVu
     */
    private ArrayList<ServiceClass> list;
    private final ArrayList<ServiceClass> listNew=new ArrayList<>();
    DefaultTableModel model;
    ServiceDAO daoService = new ServiceDAO();
    int editIndex;
    EditServiceFrm edit = new EditServiceFrm(this, rootPaneCheckingEnabled);
    
    public FrameDichVu() {
        initComponents();
        this.setLocationRelativeTo(null);
        list = new ServiceDAO().getListService();
    ...
    public void showSearch(ArrayList<ServiceClass>listt){
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(17, 17, 17)
                                .addComponent(txtSecurity, javax.swing.GroupLayout.DEFAULT_SIZE, 104, Short.MAX_VALUE))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(btnAdd)
                                .addGap(18, 18, 18)
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if(new ServiceDAO().addService(s)){
    ...
    public void showResult(){
        ServiceClass s =list.get(list.size() - 1);
        model.addRow(new Object[]{
            s.getRoom(), s.getTime(), s.getEletric(), s.getWater(), s.getSecurity(), s.getParking(), s.getCleaning(), s.getOther()
        });
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameDichVu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    void updateService(ServiceClass s) {
        s = new ServiceClass();
